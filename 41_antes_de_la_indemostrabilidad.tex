...
Las anteriores funciones simplemente se ponen de manifiesto para recalcar que todos los resultados sobre ordinales e hidras son traducibles al lenguaje de la aritmética de Peano y, por lo tanto, todo es demostrable bajo $\PA$.

\begin{prop}
    Existe una estrategia computable $\tau$ tal que 
    \[G_\tau(\alpha,n)=F(\alpha,n+1).\]
\end{prop}
\begin{proof}
    Definamos $\tau$ como la siguiente estrategia:\\
    ...
    Dado que tenemos un algoritmo para $\tau$, es una estrategia computable. Sólo basta demostrar que $G_\tau(\alpha,n)=F(\alpha,n+1)$. Sea $n$ un número natural; procedemos por inducción sobre $\alpha$:\\
    ...
    \[\alpha=\n^{\beta_1}+\cdots+\n^{\beta_m},\]
    con $\beta_1\geq\cdots\geq\beta_m$; la cuál es la forma usual de un ordinal asociado a una hidra que no es sucesor. Entonces, la cabeza que se cortará está asociada al ordinal $\n^{\beta_m}$. Consideraremos $\n^{\beta_m}\neq 0$ para evitar el caso sucesor.
    \begin{itemize}
...
\begin{obs}
    ...
    es decir, iterando la operación $P$, $k-$veces, de forma que el primer parámetro en cada ocasión es, o bien el ordinal $\beta$, o bien la iteración anterior; y el segundo parámetro uno de los elementos del conjunto $\set{n_1,\ldots,n_k}$.
...
\begin{obs}
    ...
    De manera análoga con $\underset{n}{\rightarrow}$.
\end{obs}
        ...
        \item Procedemos por inducción sobre $\beta$:
            ...
            \begin{itemize}
                ...
                \item Si $\beta\in\text{SUCC}$, existe un ordinal límite $\gamma$, y un ordinal finito no nulo $k$ tal que $\beta=\gamma+k$. Primero, observemos que:
                    ...
                    Este conjunto claro que no es vacío, pues al menos $1\in C$ por definción.
                    ...
                    Así pues, tenemos lo que afirmábamos.
                    ...
                    \begin{itemize}
                        ...
                        \item $\alpha<\gamma$. Entonces, como $\beta\underset{n}{\Rightarrow}\alpha$, entonces existe $m$ tal que:
                            ...
                            Además, $F(\beta,\underbrace{(n,\ldots,n)}_{k-\text{veces}})=\gamma$, por lo que $k<m$ y $\gamma\underset{n}{\Rightarrow}\alpha$. Así, como ya tenemos que
                            \[\n^{\gamma+k}\underset{n}{\Rightarrow}\n^\gamma,\]
...
\begin{lem}\label{kpl6}
    Supóngase que $\beta\underset{n}{\rightarrow}\alpha$ y $0<n\leq n_1<n_2<\cdots<n_k$. Entonces,
