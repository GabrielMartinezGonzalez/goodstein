...
\begin{proof}
    ...
    Notemos que $\alpha^{\gamma_1}\leq\beta_1<\beta$, por lo que $\gamma_1\in\Gamma$, luego $\gamma_1<\gamma_0$. Así, añadiendo el término $\alpha^{\gamma_0}\cdot\delta_0$ a la izquierda de la expansión $\beta_1$, obtenemos la expansión deseada para $\beta$. Ahora, mostremos la unicidad: supongamos las siguientes expansiones:
    \[\beta=\alpha^{\gamma_0}\cdot\delta_0+\alpha^{\gamma_1}\cdot\delta_1+\cdots+\alpha^{\gamma_{k-1}}\cdot\delta_{k-1};\] 
