...
\begin{proof}
    ...
    Afirmamos que el conjunto $\Gamma$ tiene un elemento máximal. En efecto, supóngase que no lo tiene y sea $\gamma_0=\bigcup\Gamma$. Como se satisface {\eqref{H}}, la ecuación descrita después del teorema \ref{t10}, $\gamma_0$ es un ordinal límite y $\gamma_0\not\in\Gamma$. Por otro lado, por definición: 
    ...
    Notemos que $\alpha^{\gamma_1}\leq\beta_1<\beta$, por lo que $\gamma_1\in\Gamma$, luego $\gamma_1<\gamma_0$. Así, añadiendo el término $\alpha^{\gamma_0}\cdot\delta_0$ a la izquierda de la expansión $\beta_1$, obtenemos la expansión deseada para $\beta$. 
    Ahora, mostremos la unicidad: supongamos que $\beta$ es el menor ordinal con dos expansiones, las cuales son:
    \[\beta=\alpha^{\gamma_0}\cdot\delta_0+\alpha^{\gamma_1}\cdot\delta_1+\cdots+\alpha^{\gamma_{k-1}}\cdot\delta_{k-1};\] 
    \[\beta=\alpha^{\gamma_0}\cdot\delta'_0+\alpha^{\gamma_1}\cdot\delta'_1+\cdots+\alpha^{\gamma_{k-1}}\cdot\delta'_{k-1},\]
    donde $\gamma_0>\gamma_1>\cdots>\gamma_{k-1}$, $\alpha>\delta_i,\delta'_i$ para $i<k$, y $\max\set{\delta_0,\delta'_0}>0$ (pues, por asumir que $\delta_i=\delta'_i=0$, podemos asumir que la secuencia de exponentes es la misma en ambas expansiones). Más aún, si $\delta_0=\delta'_0$, entonces $\beta_1=\alpha^{\gamma_1}\cdot\delta'_1+\alpha^{\gamma_1}\cdot\delta'_1+\cdots+\alpha^{\gamma_{k-1}}\cdot\delta'_{k-1}$ es el más pequeño ordinal con dos expansiones diferentes, lo cuál contradice la elección de $\beta$ (pues $\beta_1<\beta$), por lo que podemos suponer $\delta_0\neq\delta'_0$. Sin pérdida de generalidad, $\delta_0<\delta'_0$. Pero entonces:
    \[\beta=\alpha^{\gamma_0}\cdot\delta_0+\alpha^{\gamma_1}\cdot\delta_1+\cdots+\alpha^{\gamma_{k-1}}\cdot\delta_{k-1}\]
