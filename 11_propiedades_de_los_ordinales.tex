...
Es decir, $\prec$ es el orden parcial inducido por la relación $\in$ en $\alpha$. Luego, consideremos el subconjunto $\{\beta,\gamma\}$ de $\alpha$. Como $\prec$ es un buen orden, tenemos que $\beta\prec\gamma\lor\gamma\prec\beta$. Así, tenemos que:
...
\begin{enumerate}
    \item Si $\la x,y\ra\in\text{WOT}$, entonces $x$ y $\la y,\in\ra$ son buenos órdenes estrictos isomorfos. 
...
\begin{proof}\hspace{0.45cm}
    \begin{enumerate}
        ...
        \item Supongamos que $f$ y $g$ son dos funciones rango para $W$. Tomemos $z\in Z$ y supongamos, como hipótesis inductiva que para cada $yWz$
            \[f(y)=g(y).\]
            Como $f$ y $g$ son funciones rango,
            \[f(z)=\sup\set[S(f(y))]{yWz}\]
            y 
            \[g(z)=\sup\set[S(g(y))]{yWz}.\]
            Pero, por hipótesis inductiva $f(y)=g(y)$ para cada $yWz$. Entonces,
            \[\set[S(f(y))]{yWz}=\set[S(g(y))]{yWz}.\]
            Por lo tanto, 
            \[f(z)=g(z).\]
            Así, por inducción bien fundada, $f=g$ y tenemos la unicidad.
    \end{enumerate}
\end{proof}
\begin{defn}
