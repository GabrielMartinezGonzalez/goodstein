...
\begin{defn}\label{d1}
Un conjunto $\alpha$ es llamado un \textbf{ordinal} si $\alpha$ es transitivo y estrictamente bien ordenado por $\in$.
\end{defn}
...
y todo subconjunto de $\alpha$ tiene primer elemento. Se podría señalar que la irreflexividad se sigue de asumir cierto el axioma de Fundación.
\begin{thm}\label{t1}
