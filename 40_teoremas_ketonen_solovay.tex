...
\begin{proof} \hspace{1cm}\\
    ...
    5. Para la suficiencia, consideremos $I\subeq_i M$ tal que $I\vDash\PA$, $a\in I$y $b\not\in I$. Dado $k$ estandar, por la proposición {\ref{prop328}} existe $d_k>a$ tal que $d_k\in I$ (por el teorema {\ref{los}}) y $[a,d_k]$ es $\n_k-$grande, luego como $b>d_k$ y por la proposición {\ref{siabb}} y el teorema {\ref{los}}, $[a,b]$ es $\n_k-$grande. Como $k$ es arbitraria (sólo pidiendole que sea estándar), para cada $k$ estándar tenemos que:
        ...
        Para la necesidad basta observar lo siguiente: los segmentos iniciales de un modelo de $\PA$ son cerrados bajo funciones demostrablemente computables, esto es porque si $f(x)=y$ es equivalente a una expresión $\Sigma_1$ en $M$, entonces también lo es en $I$, para $I$ segmento inicial.
        Luego, por el punto 1, tenemos que $Y$ es una función demostrablemente computable. Así pues, tenemos que:
        \[(a\in I\land b\in I)\implies Y(a,b)\in I;\]
        o lo que es lo mismo:
        \[Y(a,b)\not\in I\implies (a\not\in I\lor b\not\in I).\]
        Ahora bien, todo modelo de $\PA$ tiene segmentos iniciales que satisfacen $\PA$ (al menos, la sección isomorfa al módelo estandar). Sea $I\subeq_i M$ tal que $a\in I$ y $I\vDash\PA$. Si $Y(a,b)$ es no estandar (es decir, no está en $I$), entonces 
        \[b\not\in I.\]
\end{proof}
